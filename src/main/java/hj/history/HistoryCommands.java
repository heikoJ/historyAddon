...
@Service
public class HistoryCommands implements CommandMarker { // All command types must implement the CommandMarker interface
    
    /**
     * Get a reference to the HistoryOperations from the underlying OSGi container
     */
    @Reference private HistoryOperations operations;
     ...
     */
    @CliAvailabilityIndicator({ "history setup", "history add", "history all" })
     ...
     * @param type 
     */
    @CliCommand(value = "history add", help = "Some helpful description")
     ...
     * 
     */
    @CliCommand(value = "history all", help = "Some helpful description")
    public void all() {
     ...
     * 
     */
    @CliCommand(value = "history setup", help = "Setup History addon")
    public void setup() {
        operations.setup();
    }
}