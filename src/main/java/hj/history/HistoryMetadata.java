 ...
 * @since 1.1.0
 */
public class HistoryMetadata extends AbstractItdTypeDetailsProvidingMetadataItem {



    // Constants
    private static final String PROVIDES_TYPE_STRING = HistoryMetadata.class.getName();
    ...
    public HistoryMetadata(String identifier, JavaType aspectName, PhysicalTypeMetadata governorPhysicalTypeMetadata) {
